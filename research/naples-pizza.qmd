...
| Farewell Naples | Fri June 12 | **Concettina ai Tre Santi** | ✅ **CONFIRMED** — 7:30 PM |
...
### ① Concettina ai Tre Santi — June 12 (Friday) — ✅ BOOKED

- **Status:** Confirmed — table for 2, 7:30 PM, à la carte
- **Confirmation:** sent to dgreenj@gmail.com
...
| **Hours** | Fri–Sat confirmed until 23:30; full hours — verify via website |
...
Fried pizza is separate from the sit-down pizzerias. Look for street-side vendors near Quartieri Spagnoli — a filled, folded dough fried in oil (ricotta and salumi inside). €3–5. Eat standing on the street.
