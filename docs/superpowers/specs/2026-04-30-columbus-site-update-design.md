...
**Calendar cell changes:** - **Jun 8 (Day 4):** Replace "Accademia — David / Medici Chapels / Mercato Centrale"\
→ "Ghiberti Pass / Baptistery + Duomo Museum / Santa Reparata 10:30am ⚠️" - **Jun 9 (Day 5):** Replace "Bargello Museum / Santa Croce / Local neighborhoods"\
→ "Private Uffizi + Accademia / Tour 9:00am / Via dei Castellani 14" - **Jun 11 (Day 7):** Update "Herculaneum ruins / Ancient Roman city / MANN Museum option"\
→ "Naples Walking Tour / Underground ruins + lunch / Pickup 8:30am Piazza Municipio" - **Jun 12 (Day 8):** Update "MANN Museum / Cappella Sansevero / Spaccanapoli"\
