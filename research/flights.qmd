...
## Intra-Italy Flights: Naples → Brindisi — BOOKED

**Booked:** ITA Airways (Alitalia) via Rome, **Saturday June 13**
**Reservation:** IXYZMT | Airline code: BY4EV5 (AZ)

| # | Flight | Route | Departs | Arrives | Notes |
|---|--------|-------|---------|---------|-------|
| 1 | AZ 1270 | NAP → FCO | 3:05pm | 4:05pm | Naples Capodichino → Rome Fiumicino T1 |
| 2 | AZ 1623 | FCO → BDS | 5:15pm | 6:25pm | Rome Fiumicino T1 → Brindisi |
...
There are no direct commercial flights between Naples (NAP) and Brindisi (BDS) — the route is too short and thin for direct service. Routing via Rome Fiumicino (FCO) is the only way to fly this leg. The total journey time (including connection) is approximately 3.5 hours door-to-door from central Naples — comparable to the 5.5-hour direct train option that was the original plan.
:::

See [Day 9](../daily_itineraries/day-09-2026-06-13-naples.qmd) for the full departure day plan.
